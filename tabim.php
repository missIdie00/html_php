...
<body>
    ...
    <table class="table">
        ...
        <?php foreach ($donn as  $value) :; ?>
            ...
            <tbody>
                <tr>
                    <th scope="row"><?php echo $value['idim']; ?></th>
                    
                    <td> <?php echo $value['nomim']; ?></td>
                    <td> <?php echo $value['superficie']; ?></td>
                    <td><a href="modifierprop.php? numa=<?php echo $value['idim'] ?>" class="btn btn-success">modifier</a></td>
                    <td><a href="supprimerprop.php? num=<?php echo $value['idim'] ?>" class="btn btn-danger">supprimer</a></td>
    ...
    <a href="?form=great" class="btn btn-dark" align="center">Retour</a>
    <?php
